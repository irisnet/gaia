...
var (
	...
	maccPerms = map[string][]string{
		...
		coinswap.ModuleName:             {auth.Minter, auth.Burner},
	}
...
func NewGaiaApp(
	...
	app.coinswapKeeper = coinswap.NewKeeper(app.cdc, keys[coinswap.StoreKey], app.bankKeeper, app.accountKeeper, app.subspaces[coinswap.ModuleName])
	...
	app.mm.SetOrderInitGenesis(
		...
		slashing.ModuleName, gov.ModuleName, mint.ModuleName, coinswap.ModuleName, crisis.ModuleName,
